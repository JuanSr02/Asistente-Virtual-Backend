...
public interface ExperienciaRepository extends JpaRepository<Experiencia, Long> {
    ...
    @Query("SELECT exp FROM Experiencia exp JOIN exp.examen e JOIN e.renglon r WHERE r.materia = :materia AND e.fecha >= :fechaLimite")
    List<Experiencia> findByMateriaAndFechaAfter(@Param("materia") Materia materia, @Param("fechaLimite") LocalDate fechaLimite);
