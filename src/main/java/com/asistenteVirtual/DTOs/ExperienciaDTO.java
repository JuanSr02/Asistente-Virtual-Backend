...
public class ExperienciaDTO {
    ...
    @Min(value = 0, message = "Los días de estudio deben ser cero o mayores.")
    private Integer diasEstudio;

    @NotNull(message = "Las horas diarias son obligatorias.")
    @Min(value = 0, message = "Las horas diarias deben ser cero o mayores.")
    @Max(value = 24, message = "Las horas diarias no pueden exceder las 24.")
    private Integer horasDiarias;

    @NotNull(message = "Los intentos previos son obligatorios.")
    @Min(value = 0, message = "Los intentos previos deben ser cero o mayores.")
